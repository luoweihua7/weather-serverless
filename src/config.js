module.exports = {
  ...
  STORE: {
    ...
    redis: {
      host: 'hk.vkit.run', // Redis的地址，可以是IP，也可以是域名
      port: '6379', // 端口，按照实际修改即可
      password: '118bc19f6a62300448bf48ecc6fdabd954331fe7' // Redis密码，强烈建议设置长一点的密码
    }
  },
  ...
  SERVICES: {
    ifttt: {
      key: 'mQRKtW0DVs6FSaQwI1SCaG0fgRrUj1jmt8uPFrQtkRn', // IFTTT通知的KEY，在 https://ifttt.com/maker_webhooks 右上角的 Document 按钮获取
      webhook: 'notification', // IFTTT的Webhook名，请按照实际填写
      title: '天气通知',
    ...
    sms: {
      notification: {
        Sign: 'vKit', // 在 https://console.cloud.tencent.com/smsv2/csms-sign 创建并获取，注意这里是用的是“内容”字段
        TemplateID: '896999', // 在 https://console.cloud.tencent.com/smsv2/csms-template 创建并获取
        SmsSdkAppid: '1400260908', // 在 https://console.cloud.tencent.com/smsv2/app-manage 创建并获取
        PhoneNumberSet: ['13632938163'], // 手机号码，暂时只支持国内手机号，不需要+86
        // 注意每个变量取值最多支持12个字
      ...
      alert: {
        Sign: 'vKit',
        TemplateID: '744783',
        SmsSdkAppid: '1400260908',
        PhoneNumberSet: ['13632938163'],
